 ...
 * - Please see the bottom of this file for the contents of the required sioclient.py file to make this happen.
 *
 *
 * Author:
 * Jon Bruno
...
//--------------------------------------------------------------------------------------
//
// The following are the contents of the required sioclient.py socket.io client used to communictae with the qso.freedv.org reporter website
//
//
//
//
